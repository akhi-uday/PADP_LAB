...
int is_equal(char* a,const char* key, intignore_case){
char b[20];
strcpy(b,key);
...
long determine_count(const char *file_name, const char *key, intignore_case)
{
	intkey_index=0,key_len = strlen(key);
	long word_count=0;
	charch;
